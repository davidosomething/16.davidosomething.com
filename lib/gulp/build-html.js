...
module.exports = (cb) => {
  ...
  const metalsmithBranchDebugger = require('../metalsmith-branch-debugger');
  ...
  const metalsmithMetaDebugger   = require('../metalsmith-meta-debugger');
